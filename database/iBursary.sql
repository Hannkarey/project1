...
--
-- Host: localhost
-- Generation Time: Apr 09, 2021 at 03:00 AM
...
('3bcf054e7e6ee85d17d5f6abc82dd3d308492be715', 'Demo Applicant 1', '+909876543456', '13 Jul 1998', '127000901', 'demoapplicant1@mail.com', 'a69681bcf334ae130217fea4505fd3c994f5683f', 'Female', 'Makueni', 'Mbooni West', 'Mwingi', 'Mwingi East', 'Mitangani'),
('a52ae5575b0f7e7954362beb0fd19e31d221ee394f', 'Demo Applicant', '+254737119796', '12/07/1990', '127001901', 'demoapplicant@mail.com', 'a69681bcf334ae130217fea4505fd3c994f5683f', 'Male', 'Kitui', 'Kitui', 'Mwingi', 'Mwingi East', 'Mwingi'),
('f34d68b28c248d224bf39ba914e71fd6d7a70e1000', 'Applicant 101', '7040313001', '27 Jul 1998', '35574911', 'applicant@ibursary.101', 'a69681bcf334ae130217fea4505fd3c994f5683f', 'Male', 'Makueni', 'Mbooni West', 'Kyuu', 'Kyuu', 'Mitangani'),
...
CREATE TABLE `iBursary_application` (
  ...
  `id_attachment` varchar(50) NOT NULL,
  `disability` longtext NOT NULL,
  `parent_name` varchar(50) NOT NULL,
  `father_idno` varchar(50) NOT NULL,
  `father_mobile` varchar(50) NOT NULL,
  `mother_name` varchar(50) NOT NULL,
  `mother_idno` varchar(50) NOT NULL,
  `mother_phone` varchar(50) NOT NULL,
  `gurdian_name` varchar(50) NOT NULL,
  `gurdian_idno` varchar(50) NOT NULL,
  `gurdian_phone` varchar(50) NOT NULL,
  `who_pays_fees` varchar(50) NOT NULL,
  `school_name` varchar(50) NOT NULL,
  `po_box` varchar(50) NOT NULL,
  `tel` varchar(50) NOT NULL,
  `sch_email` varchar(50) NOT NULL,
  `year_of_admno` varchar(50) NOT NULL,
  `adm_no` varchar(50) NOT NULL,
  `year_of_study` varchar(50) NOT NULL,
  `school_id_attachment` varchar(50) NOT NULL,
  `school_category` varchar(50) NOT NULL,
  `fee_payable` varchar(50) NOT NULL,
  `fee_paid` varchar(50) NOT NULL,
  `helb_loans` varchar(50) NOT NULL,
  `helb_loans_attachment` varchar(50) NOT NULL,
  `family_status` varchar(50) NOT NULL,
  `family_status_attachments` varchar(50) NOT NULL,
  `main_income_source` varchar(50) NOT NULL,
  `income_per_month` varchar(50) NOT NULL,
  ...
  `funds_disbursed` varchar(50) NOT NULL,
  `bursary_code` varchar(50) NOT NULL,
...
(1, 'a69681bcf334ae130217fea4505fd3c994f5683f', 'sysadmin@ibursary.org', 'System Administrator', 'f34d68b28c248d224bf39ba914e71fd6d7a70e1000', 'applicant@ibursary.001', 'Applicant 001', 'Test Mail', 0x54686973206973207465737420656d61696c2073656e6420766961206c6f63616c686f73742e, '2021-04-08 10:44:39', 0),
(2, 'a69681bcf334ae130217fea4505fd3c994f5683f', '', 'iBursaries - Bursary Application Bot', 'f34d68b28c248d224bf39ba914e71fd6d7a70e1016', '', 'Applicant 117', 'HVLIB 63820 - Application Status', , '2021-04-09 00:35:21', 0),
(3, 'a69681bcf334ae130217fea4505fd3c994f5683f', '', 'iBursaries - Bursary Application Bot', '3bcf054e7e6ee85d17d5f6abc82dd3d308492be715', '', 'Demo Applicant 1', 'HVLIB 63820 - Application Status', , '2021-04-09 00:38:02', 0),
(4, '', '', 'iBursaries - Bursary Application Bot', 'f34d68b28c248d224bf39ba914e71fd6d7a70e1016', '', 'Applicant 117', 'WLMKX 36702 - Application Status', , '2021-04-09 00:54:52', 0);
